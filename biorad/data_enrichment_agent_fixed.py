"""
PRISM Data Enrichment Agent - FIXED VERSION
...
class DataEnrichmentAgent:
    ...
    def initialize_company(self, company_name='BioRad Laboratories'):
        ...
        if not result:
            ...
            insert_query = """
                INSERT INTO companies (id, company_name, industry, created_at)
                VALUES (%s, %s, %s, NOW())
            """
...
Be realistic and specific. For BioRad (8,000 employees, $2.8B revenue, Life Sciences), provide accurate enterprise pricing.
