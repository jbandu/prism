 ...
 * Run with: npx ts-node load_software_data.ts
 */
...
function getVendor(softwareName: string): string {
...
function getCategory(softwareName: string): string {
...
function parseCSV(content: string): SoftwareRow[] {
...
function transformData(rows: SoftwareRow[]): ImportData[] {
