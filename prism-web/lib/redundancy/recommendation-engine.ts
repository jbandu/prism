/**
 * AI-Powered Consolidation Recommendation Engine
 * Generates smart recommendations for software consolidation
 */
...
/**
 * Generate consolidation recommendations using AI
 */
export async function generateConsolidationRecommendations(
  ...
  console.log(`🤖 Generating AI-powered consolidation recommendations...`);
...
Return ONLY valid JSON:`;
  ...
  try {
    ...
    if (!jsonMatch) {
      console.warn('No valid JSON in recommendation response');
      return null;
    }
